...
class FixturesController extends Controller
{
    ...
    public function create(Request $request, Fixture $fixture)
    {
        ...
        if ($request->away_team_id !== $request->home_team_id) {
            try {
                ...
                return response(
                    ['message' => 'Fixture creation failed', 'reason' => $e],
                    409
                );
            }
        } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->away_team_id !== $request->home_team_id) {
            try {
                ...
                return response(
                    [
                        'message' => 'Fixture update successful',
                        'fixture' => $fixture,
                    ],
                    200
                );
                ...
                return response(
                    ['message' => 'Fixture update failed', 'reason' => $e],
                    409
                );
            }
        }
    ...
    public function delete($id)
    {
        try {
            ...
            return response(
                [
                    'message' => 'Fixture deleted successful',
                    'fixture' => $fixture,
                ],
                200
            );
            ...
            return response(
                ['message' => 'Fixture delete failed', 'reason' => $e->message],
                409
            );
        }
    }
